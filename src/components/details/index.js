...
export class index extends Component {
    ...
    profRouteRenderer = () => {
        ...
        if (selectedKeyUser1 === 0 && isMortgageFrom == 0) {
            return ( <
                MortgageFrom1 isMortgageFrom = { value => this.setState({ isMortgageFrom: value }) }
        ...
        if (
            ...
            return ( <
                MortgageFromFTB isMortgageFrom = { value => this.setState({ isMortgageFrom: value }) }
                setProgress = { arg => this.setState({ progressUser1: arg }) }
                changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        ...
        if (
            ...
            return ( <
                MortgageFromSwitcherA isMortgageFrom = { value => this.setState({ isMortgageFrom: value }) }
                setProgress = { arg => this.setState({ progressUser1: arg }) }
                changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        ...
        if (
            ...
            return ( <
                MortgageFromSwitcherB isMortgageFrom = { value => this.setState({ isMortgageFrom: value }) }
                setProgress = { arg => this.setState({ progressUser1: arg }) }
                changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        ...
        if (
            ...
            return ( <
                MortgageFromMoverA isMortgageFrom = { value => this.setState({ isMortgageFrom: value }) }
                setProgress = { arg => this.setState({ progressUser1: arg }) }
                changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        ...
        if (
            ...
            return ( <
                MortgageFromMoverB isMortgageFrom = { value => this.setState({ isMortgageFrom: value }) }
                setProgress = { arg => this.setState({ progressUser1: arg }) }
                changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        ...
        if (
            ...
            return ( <
                MortgageFromMoverC isMortgageFrom = { value => this.setState({ isMortgageFrom: value }) }
                setProgress = { arg => this.setState({ progressUser1: arg }) }
                changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        ...
        if (selectedKeyUser1 === 1 && defalutClient == "user1") {
            if (
                ...
                return ( <
                    PersonalDetails21a present = { true }
            ...
            if (
                ...
                console.log(this.props.purposeOfMortgage);
                return ( <
                    PersonalDetails1 user = { this.props.user }
                    present = { true }
                    changeProfRout = { data => this.setState({ selectedKeyUser1: data }) }
                    setProgress = { arg => this.setState({ progressUser1: arg }) }
                    secPageMethod = {
                ...
                return ( <
                    PersonalDetails23a present = { true }
                    changeProfRout = { data => this.setState({ selectedKeyUser1: data }) }
                    onSubmitData = { this.onSubmitData }
                    secPageMethod = { arg => this.setState({ secPageUser1: arg }) }
                    setProgress = { arg => this.setState({ progressUser1: arg }) }
            ...
            if (
                ...
                console.log(this.props.purposeOfMortgage);
                return ( <
                    PersonalDetails1 data = { this.state.user1Data }
                    user = { this.props.user }
                    present = { true }
                    changeProfRout = { data => this.setState({ selectedKeyUser1: data }) }
                    setProgress = { arg => this.setState({ progressUser1: arg }) }
                ...
                return ( <
                    PersonalDetails22a present = { true }
                    changeProfRout = { data => this.setState({ selectedKeyUser1: data }) }
                    onSubmitData = { this.onSubmitData }
                    secPageMethod = { arg => this.setState({ secPageUser1: arg }) }
                    setProgress = { arg => this.setState({ progressUser1: arg }) }
            ...
            if (
                ...
                return <h1 > This is 2 nd Step < /h1>;
            }
            // }
        }
        if (selectedKeyUser2 === 1 && defalutClient == "user2") {
            if (
                ...
                return ( <
                    PersonalDetails21b present = { true }
                    changeProfRout = { data => this.setState({ selectedKeyUser2: data }) }
                    onSubmitData = { this.onSubmitData }
                    setProgress = { arg => this.setState({ progressUser2: arg }) }
            ...
            if (
                ...
                console.log(this.props.purposeOfMortgage);
                return ( <
                    PersonalDetails1 user2 = { this.props.financial_Health_Check }
                    present = { true }
                    changeProfRout = { data => this.setState({ selectedKeyUser2: data }) }
                    setProgress = { arg => this.setState({ progressUser2: arg }) }
                    secPageMethod = {
                ...
                return ( <
                    PersonalDetails23b present = { true }
                    changeProfRout = { data => this.setState({ selectedKeyUser2: data }) }
                    onSubmitData = { this.onSubmitData }
                    setProgress = { arg => this.setState({ progressUser2: arg }) }
                    secPageMethod = { arg => this.setState({ secPageUser2: arg }) }
            ...
            if (
                ...
                return ( <
                    PersonalDetails22b present = { true }
                    changeProfRout = { data => this.setState({ selectedKeyUser2: data }) }
                    onSubmitData = { this.onSubmitData }
                    setProgress = { arg => this.setState({ progressUser2: arg }) }
                    secPageMethod = { arg => this.setState({ secPageUser2: arg }) }
        ...
        if (selectedKeyUser1 === 2 && defalutClient == "user1") {
            return ( <
                EmployementDetails getIncomeValue = { value => this.setState({ incomeDetails: value }) }
                setProgress = { arg => this.setState({ progressUser1: arg }) }
                changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        ...
        if (selectedKeyUser1 === 3 && defalutClient == "user1") {
            return incomeDetails == "Self Employed" ? ( <
                IncomeDetailsSE changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            ) : ( <
                IncomeDetailsPYE changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        }
        if (selectedKeyUser2 === 3 && defalutClient == "user2") {
            return incomeDetails == "Self Employed" ? ( <
                IncomeDetailsSE changeProfRoute = { key => this.setState({ selectedKeyUser2: key }) }
                />
            ) : ( <
                IncomeDetailsPYE changeProfRoute = { key => this.setState({ selectedKeyUser2: key }) }
                />
            );
        }
        if (selectedKeyUser1 === 4 && defalutClient == "user1") {
            return ( <
                MonthlyOutgoings changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        }
        if (selectedKeyUser2 === 4 && defalutClient == "user2") {
            return ( <
                MonthlyOutgoings changeProfRoute = { key => this.setState({ selectedKeyUser2: key }) }
                />
            );
        }
        if (selectedKeyUser1 === 5 && defalutClient == "user1") {
            return ( <
                CreditCommentments changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        }
        if (selectedKeyUser2 === 5 && defalutClient == "user2") {
            return ( <
                CreditCommentments changeProfRoute = { key => this.setState({ selectedKeyUser2: key }) }
                />
            );
        }
        if (selectedKeyUser1 === 6 && defalutClient == "user1") {
            return ( <
                SavingAccount changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        }
        if (selectedKeyUser2 === 6 && defalutClient == "user2") {
            return ( <
                SavingAccount changeProfRoute = { key => this.setState({ selectedKeyUser2: key }) }
                />
            );
        }
        if (selectedKeyUser1 === 7 && defalutClient == "user1") {
            return ( <
                Declaration changeProfRoute = { key => this.setState({ selectedKeyUser1: key }) }
                />
            );
        }
        if (selectedKeyUser2 === 7 && defalutClient == "user2") {
            return ( <
                Declaration changeProfRoute = { key => this.setState({ selectedKeyUser2: key }) }
                />
            );
        }
    };
    ...
    render() {
        ...
        return ( <
            ...
            div > {
                this.state.defalutClient == "user1" ? ( <
                    TopSteper defaltSet = { this.state.selectedKeyUser1 }
                    ...
                    TopSteper defaltSet = { this.state.selectedKeyUser2 }
            ...
            div className = "bottonItems" > {
                this.state.selectedKeyUser1 != 0 ? ( <
                    UserNav defalutClient = { this.state.defalutClient }
